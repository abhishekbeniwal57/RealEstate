...
create table agentlogin(agent_id int PRIMARY KEY ,
username VARCHAR(50) ,
 password VARCHAR(20),
 FOREIGN KEY (agent_id) REFERENCES agent(agent_id));
drop TABLE agentlogin;
...
drop table officelogin;
insert into officelogin values('@prashant','2101150');
DROP TABLE office;
INSERT INTO Admin (username,password) values('@prashant_jha','2101150'),('@ryuk','2101159'),('@nikhil','2101132'),('@neeraj','2101130');
INSERT INTO office VALUES(125,'Bihar','Darbhanga','847103','9110982171','jhakumarprasant111@gmail.com','www.Elit properties.com');
...
drop trigger update_property_status;
...
create table oldagent(agent_id int,
  fname VARCHAR(50) not NULL,
   lname VARCHAR(50),
  email VARCHAR(50),
  phoneno VARCHAR(20) NOT NULL,
...
delete from transaction where transaction_id='PK1232';
